...
function ajouterArticle($libelleProduit,$qteProduit){
   ...
   if (creationPanier() && !isVerrouille())
   {
      ...
      else
      {
         ...
         array_push( $_SESSION['panier']['id'],$libelleProduit);
...
function modifierTaille($libelleProduit, $taille){
   //Si le panier éxiste
   if (creationPanier() && !isVerrouille())
   {
      //Si la quantité est positive on modifie sinon on supprime l'article
         ...
         if ($positionProduit !== false)
         {
            $_SESSION['panier']['taille'][$positionProduit] = $taille ;
         }
   }
   else
   echo "Un problème est survenu veuillez contacter l'administrateur du site.";
...
function supprimerArticle($libelleProduit){
   ...
   if (creationPanier() && !isVerrouille())
   {
      ...
      {
         if ($_SESSION['panier']['id'][$i] != $libelleProduit)
         {  
