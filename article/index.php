...
<div id="body-wrap">
		...
		<div id="article-title">
			<h2 id="article-name"><?php echo $nom ?></h2>
			<h3 id="article-brand"><?php echo $brand ?></h2>
		</div>


		<div id="indic-wrap">
		<div id="images-article">
			<img id="image-principal" data-src="../data/photo-articles/<?php echo $image1 ?>" class="img_art" data-loading="loading">
			<div id="sousimage">
			    <img id="image-1" class="article img_art"  data-src="../data/photo-articles/<?php echo $image1 ?>" data-loading="loading">
        		<img id="image-2"  class="article img_art" data-src="../data/photo-articles/<?php echo $image2 ?>" data-loading="loading">
        		<img id="image-3" class="article img_art" data-src="../data/photo-articles/<?php echo $image3 ?>" data-loading="loading">
		...
		<div id="indication">
			...
			<h2 class="indic-description" id="price"><?php echo number_format($prix, 2, ',', ' ') ?> €</h2>
					...
					<select id="select-size" class="dropdown-select-shop" name="taille">
						...
						if ($article['type_article'] == 'top' || $article['type_article'] == 'bottom') {
							foreach ($size as $size_) { 
								?>
								<option value="<?php echo $size_?>"><?php echo $size_?></option>
								<?php
							}
						} else {
							foreach ($size as $size_) { 
								?>
								<option value="<?php echo $size_?>">EU <?php echo $size_?> / US <?php echo $us_size[$size_]?></option>
								<?php
							}
						};
						?>
