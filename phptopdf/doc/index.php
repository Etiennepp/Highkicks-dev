...
try {
    ...
    $get_name = $bdd->prepare("SELECT * FROM comptes WHERE pseudo = ?");
    $get_name -> execute(array($_SESSION['pseudo']));
...
function Header()
{
	...
	$this->Cell(0,6,utf8_decode('Adresse de la société'),0,1);
	$this->Cell(0,6,utf8_decode('69000'),0,1);
	$this->Cell(0,6,utf8_decode('Telephone'),0,1);
	$this->Cell(0,6,utf8_decode('highkicks.fr'),0,1);
	$this->Cell(120);
	...
	$this->Cell(140,6,utf8_decode($adresse_split[0]),0,1);
	$this->Cell(120);
	$this->Cell(140,6,utf8_decode($adresse_split[1]),0,1);
	$this->Ln();
